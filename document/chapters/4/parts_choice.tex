...
% Feedback mechanism
The DFR0592 also provides a quadrature encoder interface and the integraded microcontroller (an STM32 chip) takes care of calculating the motor speed in revolutions per minute (RPM) using the configuration values and the counted pulses from the encoder.
