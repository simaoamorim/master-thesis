...
\autoref{lst:dfr_struct} (page \pageref{lst:dfr_struct}) is an excerpt of the header file containing the definition of said struct.

\lstinputlisting[float=t,language=C,firstline=24,lastline=31,caption=Definition of the DFR0592 pseudo-object C struct,label=lst:dfr_struct]{../src/DFR0592/dfr0592.h}
