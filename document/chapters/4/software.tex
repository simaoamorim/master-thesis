...
Naturaly some modification had to be made, especially because C is an event-oriented language, as oposed to Python which is mainly object-oriented.
...
Each DFR0592 board comes pre-configured with the I\textsuperscript{2}C address \verb|0x10| but they can be changed, meaning several of these boards can be used simultaneusly.
