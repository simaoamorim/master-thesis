...
In order to implement the desired EtherCAT slave (see \autoref{subsubsec:slave_devices}), one must be aware when choosing a computational platform to check the availability of a fitting ESC board and, simultaneously, the support for motor and encoder interfaces.
...
\begin{figure}[t]
	\centering
	\includegraphics[trim={2cm 12cm 2.5cm 2.5cm},width=1\textwidth,clip]{slave_architecture.pdf}
